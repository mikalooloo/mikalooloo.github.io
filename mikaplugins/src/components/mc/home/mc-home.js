        ...
        <Container className={darkMode ? 'dark-linkText' : 'light-linkText'}>
            ...
            >
                ...
                <p style={{ textAlign: 'center' }}>
                    I am a software engineer making Minecraft plugins for fun and for free!
                </p>
            </Stack>

            <Stack className="col-md-6 mx-auto" direction="horizontal" style={{ paddingBottom: '2%' }}>
                <div className={(darkMode ? 'dark-' : 'light-') + 'boxLabel'}>NEWEST RELEASE</div>
            ...
            <Stack className="col-md-6 mx-auto" direction="horizontal" style={{ paddingBottom: '2%' }}>
                <div className={(darkMode ? 'dark-' : 'light-') + 'boxLabel'}>LAST UPDATED</div>
                <div className={(darkMode ? 'dark-' : 'light-') + 'boxValue'}>
                    {lastUpdate ? (
                        <div>
            ...
            <Stack className="col-md-6 mx-auto" direction="horizontal">
                <div className={(darkMode ? 'dark-' : 'light-') + 'boxLabel'}>CURRENT PROJECT</div>
                <div className={(darkMode ? 'dark-' : 'light-') + 'boxValue'}>full-time employment :{`)`}</div>
            </Stack>
