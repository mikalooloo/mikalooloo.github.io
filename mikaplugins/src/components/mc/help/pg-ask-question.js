  ...
  return (
    <Container className={darkMode ? "dark-linkText" : "light-linkText"}>
      ...
      <p>
        ...
        If it gets too complicated for you, you can always <Link to="/minecraft/contact-me/help">Contact Me</Link> instead.
      </p>
      <h4 style={{ "paddingTop": "2%" }}>Looking to ask a question about this website? &nbsp;<FontAwesomeIcon icon={solid("arrow-pointer")} /></h4>
      <p>
        If you're super confused about something and need help, don't be afraid to <Link to="/minecraft/contact-me/confused">Contact Me</Link>.<br />
