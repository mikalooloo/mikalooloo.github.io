      ...
      <Accordion className={props.darkMode ? "gray-accordion" : "pink-accordion"} style={{"width":"50rem", "margin": "0 auto", "paddingRight":"3%", "paddingTop":"1%", "textAlign":"left"}}>
        ...
        <Accordion.Item eventKey="1">
          ...
          <Accordion.Body>
            {props.bugLink ?
            <p>
              Head on over to <span className={props.darkMode ? "dark-linkText" : "light-linkText"}><a href={props.bugLink} target="_blank" rel="noopener noreferrer">this plugin's Issues page</a></span> and look to see if there are already any existing bug reports for the same issue you're already having.<br />
              <br />If you're having the same issue, feel free to react to the original post. If you have differing or more information to provide, feel free to leave a comment!
            </p>
            :
            <p>
              ...
              Once you find that link, you can review the currently existing issues and see if someone else has already reported the bug. If someone has, feel free to react to the original report.<br />
        ...
        <Accordion.Item eventKey="2">
          ...
          <Accordion.Body>
            {props.createLink ?
            <p>
              Couldn't find an issue with your same problem? No problem! Head to <span className={props.darkMode ? "dark-linkText" : "light-linkText"}><a href={props.createLink} target="_blank" rel="noopener noreferrer">this plugin's open an issue page</a></span> and click on the "Get started" next to "Bug Report".<br />
            </p>
            :
            <p>
              Couldn't find an issue with your same problem? No problem! From that link you found before, click "New issue". From there, click on the "Get started" next to "Bug Report".<br />
            </p>}
