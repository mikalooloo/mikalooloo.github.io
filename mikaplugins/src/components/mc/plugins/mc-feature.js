          ...
          <Accordion.Body>
            {props.featureLinkOpened ?
              ...
              <p>
                ...
                Once you find that link, you can review the currently existing issues and
                see if someone else has already requested the feature {`(`}rejected or not{`)`}.<br />
        ...
        <Accordion.Item eventKey="2">
          ...
          <Accordion.Body>
            {props.createLink ?
              ...
              <p>
                No one else has posted about your ingenious idea? Awesome!
                From that link you found before, click "New issue". From there, click on the "Get started" next to "Feature Request".<br />
              </p>}
