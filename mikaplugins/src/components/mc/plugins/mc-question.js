      ...
      <Accordion 
        ...
        <Accordion.Item eventKey="1">
          ...
          <Accordion.Body>
            ...
            <p>
              ...
              Once you find that link, you can review the currently existing issues and see if someone else has already 
              asked the question {`(`}answered or not{`)`}.<br />
              If you weren't able to find your question at all, move onto the next step!
            </p>}
          </Accordion.Body>
        </Accordion.Item>
        <Accordion.Item eventKey="2">
          ...
          <Accordion.Body>
            ...
            :
            <p>
              Couldn't find an issue with your same question or weren't satisifed with the answers you found? No problem! 
              From that link you found before, click "New issue". From there, click on the "Get started" next to "Question".<br />
            </p>}
